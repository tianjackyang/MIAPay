...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/tianjackyang/MIAPay"
  ...
  s.author             = { "tianjackyang" => "919548782@qq.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "919548782@qq.com" }
  ...
  s.source       = { :git => "https://github.com/tianjackyang/MIAPay.git", :tag => s.version, :submodules => true }
